...
class Roombooking:
    def __init__(self, root):
        ...
        roomtype_list = [i[0] for i in ide]
        combo_RoomType["values"] = roomtype_list
        ...
        combo_meal["values"] = ("BreakFast", "Launch", "Dinner")
        ...
        lblimg2 = Label(self.root, image=self.photoimg3, bd=0, relief=RIDGE)
        lblimg2.place(x=760, y=55, width=520, height=200)
        ...
        # =============== tabel frame and show data table ===============
